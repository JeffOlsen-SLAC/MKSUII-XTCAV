...
set result [ run_cg_create "xilinx.com:ip:pll_sw:13.1" "clkmux" "Dynamically switch between input clock sources (PLL)" "Dynamically switch between input clock sources (PLL) (xilinx.com:ip:pll_sw:13.1) generated by Project Navigator" xc5vlx30t-1ff665 VHDL_and_Verilog ]
