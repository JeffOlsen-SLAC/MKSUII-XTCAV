...
force -freeze sim:/testbench/uut/u_Temp/Clk1MhzEn 1 0
force -freeze sim:/testbench/uut/TEMP_DIn_RDY 1

add wave -radix hex sim:/testbench/uut/u_Temp/*

add wave  \
sim:/testbench/N_TEMP_OUT_CS \
sim:/testbench/N_TEMP_IN_CS \
sim:/testbench/TEMP_DIn_RDY \
sim:/testbench/TEMP_SCLK \
sim:/testbench/TEMP_DOut
...
run 4us
force -freeze sim:/testbench/uut/TEMP_DIn_RDY 0
run 100ns
force -freeze sim:/testbench/uut/TEMP_DIn_RDY 1
run 1us
force -freeze sim:/testbench/uut/TEMP_DIn_RDY 0
